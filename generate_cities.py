...
CITIES = {
    ...
    "kyoto": {
        ...
        "pois": [
            ...
            poi("🎮","Nintendo Museum (Uji)","loisirs","Ouvert en 2024 dans l'ancienne usine Nintendo, retrace toute l'histoire de la marque des cartes Hanafuda à la Switch, expositions interactives.", "À Uji, ~45-60 min du logement (Kintetsu via Ogura) — billets uniquement par tirage au sort, dates clés dans le calendrier du guide principal", "https://museum-tickets.nintendo.com/en/", "Tirage au sort ↗"),         poi("🎬","Uzumasa Kyoto Village (ex-Toei Studio Park)","loisirs","Parc à thème dans un vrai studio de tournage de films de samouraïs (jidaigeki), figurants en costume, rues de l'époque Edo reconstituées. Rouvert le 28 mars 2026 sous ce nouveau nom après rénovation.", "Ouest de Kyoto, proche d'Arashiyama", "https://en.eigamura.com/"),
    ...
    "tokyo": {
        "icon": "🌆",
        "name": "Tokyo",
        "dates": "26 février – 10 mars 2027 · groupe séparé, réuni, interlude Fuji",
        "intro": "La plus longue étape du voyage, en plusieurs temps : 1 personne côté est dès le 26, tout le monde réuni le 28 fév. avant un interlude au Mont Fuji jusqu'au 2 mars, puis installation à Kōenji (Suginami) du 2 au 9 mars — d'abord à 6, puis à 5 après le départ du 3 mars — avant la dernière nuit près de Haneda. Tokyo est énorme — mieux vaut grouper les visites par quartier plutôt que sauter d'un bout à l'autre.",
        "cats_used": ["touristique","culturel","commerces","gastronomie","loisirs","nightlife","otaku"],
        "pois": [
            poi("🚦","Shibuya Crossing & Shibuya Sky","touristique","Le carrefour piéton le plus célèbre du monde, à voir de nuit depuis la fenêtre du Starbucks (gratuit) ou depuis l'observatoire Shibuya Sky (payant, coucher de soleil).", "Quartier de Shibuya, ~15 min en train du logement (Kōenji)"),
            ...
            poi("🎤","Karaoke-kan Shibuya","nightlife","Chaîne de karaoké la plus connue de Tokyo (rendue célèbre par le film Lost in Translation), box privatif à l'heure, ouvert très tard.", "Quartier de Shibuya, ~15 min en train du logement (Kōenji)", "https://karaokekan.jp/en/", "Site officiel Karaoke-kan ↗"),
            poi("🍸","Bars de Shibuya/Dogenzaka","nightlife","Au-delà de Golden Gai (Shinjuku), Shibuya a ses propres izakaya et bars à cocktails autour de Dogenzaka, ambiance plus jeune et moins \"institution\" que Shinjuku.", "Quartier de Shibuya, ~15 min en train du logement (Kōenji)"),
